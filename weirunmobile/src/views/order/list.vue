                ...
                <div class="list-box">
                    ...
                    <div class="list-item-box" v-for="(item,index) in list" :key="index">
                        ...
                        <div class="botttom" v-if="item.active!=6">
                            ...
                            <span class="cancel" v-if="item.active == 2 || item.active==3 || item.active==4" @click="$router.push('/order/refund/' + item.order_id)"  v-show="false">申请退款</span>
                            <span class="cancel" v-if="item.active==3 || item.active==4" @click="$router.push('/order/express/' + item.order_id)">查看物流</span>
                            <span class="pay" v-if="item.active == 2 || item.active==3 || item.active==4" @click="$router.push('/order/confirm_delivery/' + item.order_id)"  v-show="false">确认收货</span>
